...
ggplot(data=pa_counties)+
  geom_sf()+
  geom_point(data=pa_geo,aes(x=long,y=lat),color=cbPalette[1])+
  geom_point(data=blocs,aes(x=Longitude,y=Latitude),color=cbPalette[2])+
